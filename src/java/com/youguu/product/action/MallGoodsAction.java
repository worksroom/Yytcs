...
//        int dbFlag = productRpcService.shelves(mallGoods, productSetList, productExtList);
    ...
    public ActionForward updateGoods(ActionMapping mapping,
        ...
        List<MallProductCategoryProValue> proValueList = productRpcService.findProValueByProId(1);
        ResponseUtil.println(response, "");
        return null;
    }
