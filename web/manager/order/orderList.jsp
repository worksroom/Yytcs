    ...
    <script type="text/javascript">
        ...
        $(function () {
            grid = $("#maingrid").ligerGrid({
                ...
                toolbar: {
                    items: [
                        { text: '修改订单价格', click: updateData, icon: 'update' }
                    ]
                }
            });
        ...
        function updateData(){
            ...
            $.ligerDialog.open({
                url: 'manager/order/orderUpdate.jsp?orderId='+row.id+"&totalMoney="+row.totalMoney, height: 400, width: 300, buttons: [
                    {
                        ...
                        $.ajax({
                            cache: true,
                            type: "POST",
                            url:"manager/order.do?method=updateOrderPrice",
                            data: formData,
                            async: false,
                            error: function(data) {
                                $.ligerDialog.tip({
